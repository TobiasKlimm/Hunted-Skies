...
void CTerrain::Init()
{
	...
	m_pblobAll = new CBlob(0.5f, 0.5f, 0.51f, 0.51f, -0.4f, eBlobShapeGround_Rect, eBlobShapeSide_All, nullptr);
	...
	// Wasseroberfläche:
	m_zgWater.Init(WATER_SIZE, WATER_SIZE, &m_zmWater, 10, 10, 0.0f, 0.0f, 30.0f, 30.0f);
	...
	m_zmWater.SetTransparency(0.5f);//Durchsichtigkeit des Wassers
	...
	//m_zmSand.MakeTextureDiffuse("Materials\\textures\\aerial_beach_01_diff_4k.jpg");
	//m_zmSand.MakeTextureBump("Materials\\textures\\aerial_beach_01_nor_dx_4k.jpg");
	//m_zmSand.MakeTextureSpecular("Materials\\textures\\Neue Rought von Tobi.jpg");
	//m_zmSand.SetSpecularStrength(0.1f);
